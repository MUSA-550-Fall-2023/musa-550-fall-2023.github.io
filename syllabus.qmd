...
4. **From Exploration to Storytelling**: With a solid foundations, students 
...
assignment with the lowest grade will be dropped. 
...
The grading breakdown is as follows: 55% for homework; 40% for final project,
...
1. Take advantage of the [free resources](./resource/python.qmd) to help fine-tine your Python skills. 
:::
...
- Anonymous posting is enabled on Canvas — if you have a question that requires
